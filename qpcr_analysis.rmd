...
We see that the Blanks, NTCs, and treatment E (which is some sort of negative control?) have CT > 35, with a few outliers.
...
The Loess smoother is uninteresting because it will just draw a curve through the points with no error.

On the other hand, we now have much wider error bars on our linear estimates.
